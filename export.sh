...
docker save ben_lib_builder_ubuntu_21.04 | 7z a -si -m0=lzma2 -mx=9 -mmt12 -ms=on -aoa ben_lib_builder_ubuntu_21.04.tar.7z 
#docker save ben_lib_builder_fedora_34 | 7z a -si -m0=lzma2 -mx=9 -mmt12 -ms=on -aoa ben_lib_builder_fedora_34.tar.7z 
