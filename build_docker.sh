...
docker build -t ben_lib_builder_ubuntu_21.04 -f config_docker/Dockerfile_ubuntu_21.04 . --build-arg UID=$(id -u) --build-arg GID=$(id -g) --build-arg IMAGE=ubuntu:21.04
