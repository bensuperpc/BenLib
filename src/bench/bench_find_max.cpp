...
int main()
{
    ...
    std::vector<std::pair<const size_t, int *>> n_ptr = {{n * 2, n1}, {n * 4, n2}, {n * 8, n3}, {n * 16, n4},
    {n * 32, n5}, {n * 64, n6}, {n * 128, n7}, {n * 256, n8}, {n * 512, n9}, {n * 1024, n10}, {n * 2048, n11},
    {n * 4096, n12}, {n * 8192, n13}, {n * 16384, n14}};
